 ...
 * This typeclass is used to hold onto the associated Cassandra types associated
 * with the Scala types for the underlying Datastax API and handle boxing where
 * needed. This is used to handle Cassandra nested collections
 *
 * @tparam Scala
